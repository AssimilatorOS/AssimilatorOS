...
| --- | --- | --- | --- |
| BusyBox | 1.38.0 | [GPLv2](3rdparty/busybox-1.38.0/LICENSE) | https://www.busybox.net/ |
| Linux Kernel | 5.10.230 (LTS) | [GPLv2](3rdparty/linux-5.10.230/COPYING) | https://www.kernel.org/ |
| GNU Grub | 2.14 | [GPLv3](3rdparty/grub-2.14) | https://www.gnu.org/software/grub/ |
...
| Linux PAM | 1.7.2 | [GPLv2/BSD-3 Clause](3rdparty/Linux-PAM-1.7.2/COPYING) | https://github.com/linux-pam/linux-pam |
| JQ | 1.8.2 | [CC-BY-3.0/MIT](3rdparty/jq-1.8.2/COPYING) | https://jqlang.github.io/jq/ |
| SQLite3 | 3.53.3 | [Public Domain](https://sqlite.org/copyright.html) | https://sqlite.org/index.html |
| Rsync | 3.4.4 | [GPLv3](3rdparty/rsync-3.4.4/COPYING) | https://rsync.samba.org/ |
| GNU Nano Editor | 9.1 | [GPLv3](3rdparty/nano-9.1/COPYING) | https://www.nano-editor.org/ |
| NCurses | 6.6 | [MIT](3rdparty/ncurses-6.6/COPYING) | https://invisible-island.net/ncurses/ |
| Dialog | 1.3 | [LGPLv2.1](3rdparty/dialog-1.3-20260107/COPYING) | https://invisible-island.net/dialog/ |
| XFS Progs | 6.19.0 | [GPLv2](3rdparty/xfsprogs-6.19.0/LICENSES/GPL-2.0) | https://xfs.wiki.kernel.org/ |
